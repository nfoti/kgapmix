...
for si = 2:numel(seeds)
  ...
  system('mkdir -p motor_box_slice');
  save(['motor_box_slice/motor_box_slice_' num2str(si) '.mat'], 'pll_slice', 'pll_slice_rb', 'pl_slice', 'plse_slice', ...
