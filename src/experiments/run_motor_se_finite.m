% Run finite smapler on motorcycle data with square exponential kernel.
%
...
for si = 2:numel(seeds)
  ...
  system('mkdir -p motor_se_finite');
  save(['motor_se_finite/motor_se_finite_' num2str(si) '.mat'], 'pll_finite', 'pl_finite', 'pl2_finite', ...
