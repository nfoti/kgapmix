...
fprintf('   samplePsi [false]: whether to sample kernel scale for atoms\n');
fprintf('   samplePhi [true]: whether to sample mixture parameters\n');
fprintf('   singlePhi [false]: indicates if all atoms have same precision\n');
